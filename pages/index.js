...
export default function Home() {
  return (
    <div className="font-Poppins">
      ...
      {/* About Me */}
      <section className="bg-bookmark-purple py-20 mt-20 lg:mt-60">
        <div className="sm:w-3/4 lg:w-3/5 mx-auto px-2">
          <h1 className="text-2xl text-center text-bookmark-white">
            Hi, I’m Kevin and I'm looking for a team that allows me to
            perpetually get out of my comfort zone. The MERN stack, NextJs and
            Wordpress is where I spend bulk of my time learning, but I’m always
      ...
      <section className="bg-bookmark-white py-20">
        ...
        <div className="relative mt-20 lg:mt-24">
          <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
            {/* Image */}
            <div className="flex flex-col flex-1 justify-center z-10 mb-10 lg:mb-0">
              <h3 className="text-bookmark-blue text-xl md:text-2xl text-center lg:text-left mb-6">
                Video Demo
              </h3>
              <img
            ...
            <div className="flex flex-1 flex-col items-center lg:items-start">
              <h1 className="text-3xl text-bookmark-blue">
                <span className="font-bold">Know </span>What To Pick Eating Out
              </h1>
      ...
      {/* Features */}
      <section className="bg-bookmark-white pt-20 pb-40">
        {/* Heading */}
        <div className="sm:w-3/4 lg:w-5/12 mx-auto px-2">
          <h1 className="text-3xl text-center text-bookmark-blue">Blog</h1>
          {/* <p className="text-center text-bookmark-grey mt-4">
            Helping ideas come into the world one line of code at a time below.
          </p> */}
        </div>
        {/* Project #1 */}
        <div className="relative mt-20 lg:mt-24">
          <div className="container flex flex-row-reverse items-center justify-center gap-x-24 z-10">
            {/* Image */}
            <div className="flex flex-col flex-1 justify-center z-10 mb-10 lg:mb-0">
              <h3 className="text-bookmark-blue text-xl md:text-2xl text-center lg:text-left mb-6">
                Video Demo
      ...
      <section className="bg-bookmark-purple py-20">
        ...
        {/* Project #1 */}
        <div className="relative sm:w-3/4 lg:w-5/12 mx-auto mt-20 lg:mt-24">
          <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
            {/* Image */}
            <div className="flex flex-col flex-1 justify-center z-10 mb-10 lg:mb-0">
              <h1 className="text-3xl text-center text-white">
                <span className="font-bold text-white">So, </span>I Would Love
                To Talk!
              </h1>
              <img
                className="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full"
